<!-- resources/views/loan.blade.php -->
 ...
 <?php $__env->startSection('content'); ?>
     ...
     <div class="card-body">
         ...
         <!-- バリデーションエラーの表示に使用-->
         <!-- 登録フォーム -->
         <form action="<?php echo e(url('loan')); ?>" method="POST" class="form-horizontal">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/cms/resources/views/loan.blade.php ENDPATH**/ ?>